...
local CHARACTER_DESCRIPTION = {
	...
	"Cheeseter: Yoshi Player Model",
	"melzinoff: Yoshi Cap Models",
	"YellowBlur: Flutter Jump Code"
}
local CREDITS = "Coolcord"

local E_MODEL_YOSHI_GREEN = smlua_model_util_get_id("yoshi_player_geo_green")
local E_MODEL_YOSHI_RED = smlua_model_util_get_id("yoshi_player_geo_red")
local E_MODEL_YOSHI_BLUE = smlua_model_util_get_id("yoshi_player_geo_blue")
local E_MODEL_YOSHI_LIGHT_BLUE = smlua_model_util_get_id("yoshi_player_geo_light_blue")
local E_MODEL_YOSHI_YELLOW = smlua_model_util_get_id("yoshi_player_geo_yellow")
local E_MODEL_YOSHI_ORANGE = smlua_model_util_get_id("yoshi_player_geo_orange")
local E_MODEL_YOSHI_PINK = smlua_model_util_get_id("yoshi_player_geo_pink")
local E_MODEL_YOSHI_PURPLE = smlua_model_util_get_id("yoshi_player_geo_purple")
local E_MODEL_YOSHI_BLACK = smlua_model_util_get_id("yoshi_player_geo_black")
local E_MODEL_YOSHI_WHITE = smlua_model_util_get_id("yoshi_player_geo_white")
...
if _G.charSelectExists then
    _G.charSelect.character_add("Yoshi (Green)", CHARACTER_DESCRIPTION, CREDITS, { r = 65, g = 235, b = 35}, E_MODEL_YOSHI_GREEN, CT_TOAD, TEX_GREEN_YOSHI_ICON)
	_G.charSelect.character_add("Yoshi (Red)", CHARACTER_DESCRIPTION, CREDITS, { r = 238, g = 0, b = 0 }, E_MODEL_YOSHI_RED, CT_TOAD, TEX_RED_YOSHI_ICON)
	_G.charSelect.character_add("Yoshi (Blue)", CHARACTER_DESCRIPTION, CREDITS, { r = 100, g = 150, b = 250 }, E_MODEL_YOSHI_BLUE, CT_TOAD, TEX_BLUE_YOSHI_ICON)
	_G.charSelect.character_add("Yoshi (Light Blue)", CHARACTER_DESCRIPTION, CREDITS, { r = 0, g = 255, b = 255 }, E_MODEL_YOSHI_LIGHT_BLUE, CT_TOAD, TEX_LIGHT_BLUE_YOSHI_ICON)
	_G.charSelect.character_add("Yoshi (Yellow)", CHARACTER_DESCRIPTION, CREDITS, { r = 255, g = 255, b = 0 }, E_MODEL_YOSHI_YELLOW, CT_TOAD, TEX_YELLOW_YOSHI_ICON)
	_G.charSelect.character_add("Yoshi (Orange)", CHARACTER_DESCRIPTION, CREDITS, { r = 255, g = 128, b = 0 }, E_MODEL_YOSHI_ORANGE, CT_TOAD, TEX_ORANGE_YOSHI_ICON)
	_G.charSelect.character_add("Yoshi (Pink)", CHARACTER_DESCRIPTION, CREDITS, { r = 255, g = 128, b = 128 }, E_MODEL_YOSHI_PINK, CT_TOAD, TEX_PINK_YOSHI_ICON)
	_G.charSelect.character_add("Yoshi (Purple)", CHARACTER_DESCRIPTION, CREDITS, { r = 158, g = 64, b = 186 }, E_MODEL_YOSHI_PURPLE, CT_TOAD, TEX_PURPLE_YOSHI_ICON)
	_G.charSelect.character_add("Yoshi (Black)", CHARACTER_DESCRIPTION, CREDITS, { r = 150, g = 150, b = 150 }, E_MODEL_YOSHI_BLACK, CT_TOAD, TEX_BLACK_YOSHI_ICON)
	_G.charSelect.character_add("Yoshi (White)", CHARACTER_DESCRIPTION, CREDITS, { r = 255, g = 255, b = 255 }, E_MODEL_YOSHI_WHITE, CT_TOAD, TEX_WHITE_YOSHI_ICON)
	
	-- add the caps for each yoshi
	_G.charSelect.character_add_caps(E_MODEL_YOSHI_GREEN, yoshiCaps)
	_G.charSelect.character_add_caps(E_MODEL_YOSHI_RED, yoshiCaps)
	_G.charSelect.character_add_caps(E_MODEL_YOSHI_BLUE, yoshiCaps)
	_G.charSelect.character_add_caps(E_MODEL_YOSHI_LIGHT_BLUE, yoshiCaps)
	_G.charSelect.character_add_caps(E_MODEL_YOSHI_YELLOW, yoshiCaps)
	_G.charSelect.character_add_caps(E_MODEL_YOSHI_ORANGE, yoshiCaps)
	_G.charSelect.character_add_caps(E_MODEL_YOSHI_PINK, yoshiCaps)
	_G.charSelect.character_add_caps(E_MODEL_YOSHI_PURPLE, yoshiCaps)
	_G.charSelect.character_add_caps(E_MODEL_YOSHI_BLACK, yoshiCaps)
	_G.charSelect.character_add_caps(E_MODEL_YOSHI_WHITE, yoshiCaps)
	
	-- add the palettes for each yoshi
	_G.charSelect.character_add_palette_preset(E_MODEL_YOSHI_GREEN, PALETTE_YOSHI_GREEN)
	_G.charSelect.character_add_palette_preset(E_MODEL_YOSHI_RED, PALETTE_YOSHI_RED)
	_G.charSelect.character_add_palette_preset(E_MODEL_YOSHI_BLUE, PALETTE_YOSHI_BLUE)
	_G.charSelect.character_add_palette_preset(E_MODEL_YOSHI_LIGHT_BLUE, PALETTE_YOSHI_LIGHT_BLUE)
	_G.charSelect.character_add_palette_preset(E_MODEL_YOSHI_YELLOW, PALETTE_YOSHI_YELLOW)
	_G.charSelect.character_add_palette_preset(E_MODEL_YOSHI_ORANGE, PALETTE_YOSHI_ORANGE)
	_G.charSelect.character_add_palette_preset(E_MODEL_YOSHI_PINK, PALETTE_YOSHI_PINK)
	_G.charSelect.character_add_palette_preset(E_MODEL_YOSHI_PURPLE, PALETTE_YOSHI_PURPLE)
	_G.charSelect.character_add_palette_preset(E_MODEL_YOSHI_BLACK, PALETTE_YOSHI_BLACK)
	_G.charSelect.character_add_palette_preset(E_MODEL_YOSHI_WHITE, PALETTE_YOSHI_WHITE)

    -- the following must be hooked for each character added
    _G.charSelect.character_add_voice(E_MODEL_YOSHI_GREEN, VOICETABLE_CHAR_NORMAL)
	_G.charSelect.character_add_voice(E_MODEL_YOSHI_RED, VOICETABLE_CHAR_UP3)
	_G.charSelect.character_add_voice(E_MODEL_YOSHI_BLUE, VOICETABLE_CHAR_DOWN2)
	_G.charSelect.character_add_voice(E_MODEL_YOSHI_LIGHT_BLUE, VOICETABLE_CHAR_DOWN1)
	_G.charSelect.character_add_voice(E_MODEL_YOSHI_YELLOW, VOICETABLE_CHAR_UP1)
	_G.charSelect.character_add_voice(E_MODEL_YOSHI_ORANGE, VOICETABLE_CHAR_UP2)
	_G.charSelect.character_add_voice(E_MODEL_YOSHI_PINK, VOICETABLE_CHAR_UP4)
	_G.charSelect.character_add_voice(E_MODEL_YOSHI_PURPLE, VOICETABLE_CHAR_DOWN3)
	_G.charSelect.character_add_voice(E_MODEL_YOSHI_BLACK, VOICETABLE_CHAR_DOWN4)
	_G.charSelect.character_add_voice(E_MODEL_YOSHI_WHITE, VOICETABLE_CHAR_UP5)
	
	-- add in movesets
	character_set_yoshi_moveset(E_MODEL_YOSHI_GREEN)
	character_set_yoshi_moveset(E_MODEL_YOSHI_RED)
	character_set_yoshi_moveset(E_MODEL_YOSHI_BLUE)
	character_set_yoshi_moveset(E_MODEL_YOSHI_LIGHT_BLUE)
	character_set_yoshi_moveset(E_MODEL_YOSHI_YELLOW)
	character_set_yoshi_moveset(E_MODEL_YOSHI_ORANGE)
	character_set_yoshi_moveset(E_MODEL_YOSHI_PINK)
	character_set_yoshi_moveset(E_MODEL_YOSHI_PURPLE)
	character_set_yoshi_moveset(E_MODEL_YOSHI_BLACK)
	character_set_yoshi_moveset(E_MODEL_YOSHI_WHITE)
